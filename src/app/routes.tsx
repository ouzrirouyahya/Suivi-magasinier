...
export const AppRoutes: React.FC = () => (
  <Suspense fallback={<LoadingScreen />}>
    <Routes>
      ...
      <Route path="/messaging" element={<ProtectedRoute><ErrorBoundary componentName="MessagingPage"><MessagingPage /></ErrorBoundary></ProtectedRoute>} />
