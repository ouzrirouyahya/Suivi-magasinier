...
const LOCAL_PERFOS = [
  ...
  { code: 'MONTALBERT T23 4', label: 'Perfo Montalbert T23 #04', type: 'PERFO', location: 'Chantier Central', manager: 'A. Nasri' },
  { code: 'MONTALBERT T23 5', label: 'Perfo Montalbert T23 #05', type: 'PERFO', location: 'Chantier Sud', manager: 'Y. Ouzrir' },
  { code: 'MONTALBERT T23 6', label: 'Perfo Montalbert T23 #06', type: 'PERFO', location: 'Chantier Est', manager: 'S. Belkacem' },
