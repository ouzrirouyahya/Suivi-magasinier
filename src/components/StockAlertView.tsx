...
export function StockAlertView({ articles, currentSite, onAction }: StockAlertViewProps) {
  ...
  const displayedArticles = isExpanded ? lowStockArticles : lowStockArticles.slice(0, 3);
        ...
        <div className="space-y-6">
          ...
          {lowStockArticles.length > 3 && (
            <div className="flex justify-center pt-2">
              ...
              >
                <span>{isExpanded ? "Afficher moins d'alertes" : `Afficher plus d'alertes (${lowStockArticles.length - 3} de plus)`}</span>
